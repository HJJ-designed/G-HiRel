...
def get_questions(MQuAKE_path):
    questions_data = []

    with open(MQuAKE_path, 'rb') as f:
        mquake_objects = ijson.items(f, 'item')
        for index, mquake_object in enumerate(mquake_objects):
...
if __name__ == "__main__":
    ...
    questions_data_path = r"../data/MQUAKE/MQuAKE-CF-3k.json"
    file_output_path = r"./target_relation/Question/target_relations_MQuAKE_4o-mini.txt"

    # questions_data_path = r"../data/MQUAKE-T/MQuAKE-T.json"
    # file_output_path = r"./target_relation/Question/target_relations_MQuAKE_T_4o-mini.txt"

    pid_path = r"../KG/relationships/pid2Name/pid2Name.csv"

    questions_data = get_questions(questions_data_path)
    ...
    print(questions_data_path)
    print(file_output_path)
    print(pid_path)

    init_prompt = get_init_prompt(init_prompt_path, pid_path)

    get_target_relations(init_prompt, questions_data, file_output_path)
