...
if __name__ == "__main__":
    ...
    file_output_path = r"./target_relation/subQuery/target_relations_MQuAKE_gpt_4o_mini.txt"

    # reference_data_path = r"../QuestionReformulation/sub_query/mquake_t_sub_query.txt"
    # file_output_path = r"./target_relation/subQuery/target_relations_MQuAKE_T_gpt_4o_mini.txt"
